...
public class AllStates {
    public static void main(String[] args)throws InterruptedException {
        ...
        System.out.println(t1.getName()+" "+t1.getState());//t1 is in RUNNABLE
        Thread.sleep(100);// main thread RUNNABLE -> TIMED WAITING for 100ms
        System.out.println(t1.getName()+" "+t1.getState());//100ms lapsed main is RUNNABLE, 2000ms-100ms time remaining for t1,so t1 still in TIMED WAITING state.
